...
namespace MyRevisionHelper
{
    ...
    {
        // A local integer variable is created with a scope of the Qna form that holds the value of the number of questions
        private int numOfQVal;

        // A local integer variable is created with a scope of the Qna form that holds the next question number
        private int nextQNo;

        // A local integer variable is created with a scope of the Qna form that holds the number of questions answered correctly
        private int numOfQAnsCorr;
        
        // Creates an instance of the object qnaActivity
        private QnaActivity activity = new QnaActivity();
