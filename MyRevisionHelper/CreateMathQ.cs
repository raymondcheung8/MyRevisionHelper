...
{
    public partial class CreateMathQ : Form
    {
        public CreateMathQ()
        {
            InitializeComponent();
        ...
        // Main method
        private void CreateMathQ_Load(object sender, EventArgs e)
        {
        ...
        private void store_btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection())
                {
                    ...
                    if (question_textBox.Text != "" && equation_textBox.Text != "" && ranges_textBox.Text != "" && dp_textBox.Text != "")
                    {
                        ...
                        if (createActivity.createMathQ(connection, question_textBox.Text, equation_textBox.Text, ranges_textBox.Text, dp_textBox.Text))
                        {
